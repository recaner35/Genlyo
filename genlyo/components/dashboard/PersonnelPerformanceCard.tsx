...
export default function PersonnelPerformanceCard({ 
    ...
    return (
        <div className="bg-gradient-to-br from-cyan-50 to-sky-50 rounded-3xl p-6 border border-cyan-100 shadow-sm flex flex-col justify-between h-full relative overflow-hidden">
            <div>
                    ...
                    <div className="flex-1 space-y-1 min-w-0">
                        {personnelSales.slice(0, 3).map((p, i) => (
                            <div key={i} className="flex items-center gap-1.5 text-[9px] font-bold">
                                ...
                                <span className="text-cyan-900 truncate">{p.personnel?.firstName || p.firstName}</span>
